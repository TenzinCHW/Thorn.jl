mutable struct LIFNeuron{T<:AbstractFloat} <: ProcessingNeuron
    ...
    function LIFNeuron(id::Int, u=def_u, rest_u=def_rest_u, spike_u=def_spike_u, alpha=def_alpha, tau=def_tau, thresh=def_thresh, homeostasis_a=def_homeostasis_a, homeostasis_b=def_homeostasis_b, u_func=dt->def_u)
