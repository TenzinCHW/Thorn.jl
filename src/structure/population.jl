...
function update_weights!(pop::NeuronPopulation, weights::Array{AbstractFloat, 1}, spike::Spike)
    # Update the given weights
    # Assign the spike to the last_spike variable of the pop
    weights = pop.weight_update.(pop.neurons, weights, spike, pop.last_spike)
